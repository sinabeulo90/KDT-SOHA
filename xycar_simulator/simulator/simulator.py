...
class Simulator(object):
    ...
    """
    def __init__(self, map="rally_map2.png", fps=10, reward_radius=100):
        ...
        self.reward_domain = get_reward_domain(self.map, self.car, self.reward_radius)

        self.is_done = False


    def render(self, fps=None, display=True):
    ...
    def step(self, gear, steering_deg):
        ...
        if is_done or np.min(distances_meter) <= 10:
            self.is_done = True
            return distances_meter, -1, self.is_done
