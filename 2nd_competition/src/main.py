...
while rm.get_shutdown():
    ...
    for qtcode in qrcodes:
        ...
        if qr_string=="1 algorithm drive_avoid_obstacle":
            ...
            #mode="DQNQR"
            mode="ULTRASONICQR"
        elif qr_string =="dqn dqn_drive_end" or qr_string=="4 dqn dqn_drive_end":
            mode="YOLOQR"
            #mode="ULTRASONICQR"


        elif qr_string =="9 ar parking" or mode == "7 algorithm drive_to_parking_lot_1":
            mode="PARKQR"

    print(str(start)+" mode : "+str(mode))
