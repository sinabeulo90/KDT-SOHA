...
from module.sliding_window.sliding_window import get_points_with_sliding_window, get_steering_angle_from_linear_function
...
class SlidingWindowHandler(AbstractHandler):
    ...
    def handle(self, frame):
        ...
        motor_angle = self._get_steering_angle(frame)
